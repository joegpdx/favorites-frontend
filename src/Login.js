...
export default class Login extends Component {
    ...
    handleSignIn = async (e) => {
        e.preventDefault();
        const user = await request.post('https://evening-dusk-favorites.herokuapp.com/api/auth/signin', {
    ...
    handleSignUp = async (e) => {
        e.preventDefault();
        const user = await request.post('https://evening-dusk-favorites.herokuapp.com/api/auth/signup', {
        ...
        return (
            <div>
                ...
                <form onSubmit={ this.handleSignUp }>
                    ...
                    <input onChange={(e) => this.setState({ signUpPassword: e.target.value })} />
